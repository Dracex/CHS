...
<html lang="es">
	<head>
		...
		<link rel="stylesheet" href="style/css/imagenes.css">
		<script src="style/js/jQuery.js"></script>
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
		<script src="style/js/jQueryGeneral.js"></script>
		<script src="style/js/jQueryImagenes.js"></script>
		<script src="style/js/buscar.js"></script>
				...
				<div class="blanco">
					...
					<nav id="pcnav">
						<ul>
							...
							?>
							<li><a href="http://caminahaciasantiago.esy.es/configuracion.php">Foro<div class="ico derecha" id="foro"></div></a></li>
					...
					<nav id="phonenav">
						...
						<ul id="ul-phone" class="cerrar">
							...
							<li><a href="http://caminahaciasantiago.esy.es/configuracion.php">Foro</a></li>
